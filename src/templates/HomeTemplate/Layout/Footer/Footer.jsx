...
import { getTheaterDetailsFooterAction } from "../../../../redux/actions/TheaterManagementAction";

export default function Footer(props) {
	const { arrTheatersFooter } = useSelector(
	...
	useEffect(() => {
		dispatch(getTheaterDetailsFooterAction());
	}, [dispatch]);
		...
		<footer className='footer-app'>
			<div className='container'>
				<div>
					...
					<div className='theatersLogoFooter'>
						<p>Partner</p>
						<div>
							{arrTheatersFooter.map((theater, index) => {
								return (
									<img
										src={theater.logo}
